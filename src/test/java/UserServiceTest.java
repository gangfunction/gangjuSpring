...
import static service.TestUserService.transactionManager;
...
public class UserServiceTest {
    ...
    public void pointcutAdvisor(){
        ...
        pfBean.addAdvisor(new DefaultPointcutAdvisor((Pointcut) pointcut, (Advice) new DynamicProxyTest.UppercaseAdvice()));
