package main.springbook.learningtest.spring.pointcut;
...
public class PointcutExpressionTest {
    ...
    public void pointcut() throws Exception{
        targetClassPointcutMatches("execution(public void * * learningtest.spring.pointcut.Target.hello())", true, true, true, true, true, true);
    }
}
